...
CREATE TABLE "public"."WarehouseItem" (
    "id" TEXT NOT NULL,
    "code" TEXT NOT NULL,
    "rawWeightKg" DECIMAL(65,30) NOT NULL,
    "moisturePct" DECIMAL(65,30),
    "cleanWeightKg" DECIMAL(65,30) NOT NULL,
    "location" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "public"."Order" (
    ...
    "productSpec" TEXT,
    "requestedKg" DECIMAL(65,30) NOT NULL,
...
CREATE TABLE "public"."OrderAllocation" (
    ...
    "allocatedKg" DECIMAL(65,30) NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "public"."Batch" (
    ...
    "code" TEXT NOT NULL,
    "sourceItemId" TEXT,
    "totalInputKg" DECIMAL(65,30) NOT NULL,
...
CREATE TABLE "public"."StageRun" (
    ...
    "inputKg" DECIMAL(65,30) NOT NULL,
    "outputKg" DECIMAL(65,30),
    "wasteKg" DECIMAL(65,30),
    "qualityNote" TEXT,
    "operatorId" TEXT,
...
CREATE TABLE "public"."WasteRecord" (
    ...
    "kind" TEXT NOT NULL,
    "amountKg" DECIMAL(65,30) NOT NULL,
    "note" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
